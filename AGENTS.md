...
This repo is the **Shannon CLI** — a headless Python + C++20 library (entropy
...
- C++ tests: configure with `-DCMAKE_CXX_COMPILER=g++-13`, then run `ctest` with
  the CI filter `-E 'Avx512|SimdLog2Avx2.MaxRelativeError'` — hosted/VM CPUs may
