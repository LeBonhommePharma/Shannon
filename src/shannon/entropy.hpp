...
double configurational_entropy_scalar(const double* w, std::size_t n);
...
double entropy_from_probs_scalar(const double* p, std::size_t n);
...
double entropy_from_logprobs_scalar(const double* lp, std::size_t n);
